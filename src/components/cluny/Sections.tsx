    ...
    >
      ...
      <div aria-hidden className="absolute inset-0">
        <img
          ...
          fetchPriority="high"
        />
        {/* Overlay para legibilidade — gradient lateral papel + véu suave */}
        <div
          className="absolute inset-0"
          style={{
            background:
              "linear-gradient(90deg, rgba(244,241,236,0.96) 0%, rgba(244,241,236,0.72) 32%, rgba(244,241,236,0.25) 55%, rgba(244,241,236,0.05) 100%)",
          }}
        />
        <div
          className="absolute inset-0"
          style={{
            background:
              "radial-gradient(900px 500px at 90% 10%, rgba(196,139,48,0.18), transparent 60%)",
          }}
        />
        {/* grade fina decorativa */}
        <div
          className="absolute inset-0 opacity-[0.05] hero-deco-mobile-hide"
          style={{
            backgroundImage:
      ...
      <div className="relative max-w-[1440px] w-full mx-auto px-6 lg:px-12 pt-[72px] pb-16 min-h-[480px] lg:min-h-[540px] flex flex-col">
        ...
        <div className="relative z-10 flex-1 flex items-center">
          <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <h1 className="lg:col-span-8 font-display font-semibold text-[#1F3D2E] leading-[0.88] tracking-[-0.04em]">
              <span className="block text-[44px] sm:text-6xl md:text-7xl lg:text-[7.5rem] xl:text-[8.5rem] whitespace-nowrap">
                Sua empresa cresce<span style={{ color: "#c48b30" }}>.</span>
              </span>
              <span
                className="block italic font-normal mt-3 lg:mt-5 text-[26px] sm:text-4xl md:text-5xl lg:text-[3.5rem]"
                style={{ color: "#005a54" }}
              >
            ...
            {/* Tagline + CTA — coluna direita estilo Reise */}
            <div className="lg:col-span-4 lg:pl-6 lg:border-l lg:border-[#1F3D2E]/15 flex flex-col items-start gap-5 lg:gap-6 lg:mt-2">
              <p className="font-display italic text-[#1F3D2E]/80 text-lg lg:text-xl leading-snug max-w-[320px]">
                Liberamos você, empresário, para cuidar do crescimento da empresa.
              </p>
              <a
                href="#diagnostico"
                className="group bg-[#005a54] hover:bg-[#1F3D2E] transition-colors duration-500 px-8 lg:px-10 py-4 lg:py-5 rounded-full inline-flex items-center gap-3 text-[#f4f1ec] font-sans font-semibold text-base lg:text-lg shadow-2xl"
                style={{ boxShadow: "0 18px 50px -12px rgba(0,90,84,0.55)" }}
              >
              ...
              <div className="flex items-center gap-2">
                ...
                <span style={{ fontFamily: "JetBrains Mono, ui-monospace, monospace", fontSize: 11, color: "#1F3D2E" }}>
                  NPS 94 · +500 empresas · 12 anos
                </span>
              </div>
            </div>
          </div>
        ...
        {/* Dots decorativos (referência Reise) */}
        <div className="relative z-10 flex items-center justify-center gap-2 mt-10 hero-deco-mobile-hide">
          <span className="w-2 h-2 rounded-full bg-[#1F3D2E]" />
          <span className="w-2 h-2 rounded-full bg-[#1F3D2E]/30" />
          <span className="w-2 h-2 rounded-full bg-[#1F3D2E]/30" />
        </div>

        {/* Camada de elementos financeiros flutuantes */}
        <div className="absolute inset-0 pointer-events-none z-[5]">
          {/* KPI card — lateral esquerda meio */}
          <div className="pointer-events-auto absolute top-1/2 -translate-y-1/2 left-2 lg:left-6 bg-[#1F3D2E] text-[#f4f1ec] p-4 shadow-2xl w-[180px] hero-deco-mobile-hide float-card-2 rounded-sm hidden xl:block">
            ...
            <svg viewBox="0 0 100 28" className="w-full h-7" aria-hidden>
              <polyline fill="none" stroke="#c48b30" strokeWidth="1.5" points="0,22 12,18 24,20 36,14 48,16 60,10 72,12 84,6 100,4" />
              <polyline fill="none" stroke="#005a54" strokeWidth="1" strokeDasharray="2,2" points="0,24 100,16" />
            </svg>
          </div>

          {/* Card brass — bottom left */}
          <div className="pointer-events-auto absolute bottom-20 left-4 lg:left-12 bg-[#f4f1ec] p-5 lg:p-6 shadow-2xl max-w-[240px] hero-deco-mobile-hide border-l-4 border-[#c48b30] float-card-1">
            <p className="font-display text-base lg:text-lg text-[#1F3D2E] leading-tight mb-2">
          ...
          {/* Tag pulse */}
          <div className="pointer-events-auto absolute top-4 right-6 lg:right-14 bg-[#005a54] text-[#f4f1ec] px-3 py-1.5 shadow-lg flex items-center gap-2 hero-deco-mobile-hide float-card-2 rounded-full">
...
/* ============= DIAGNÓSTICO INTERATIVO · 12 PERGUNTAS ============= */
type DiagOpt = { label: string; risco: number };
type DiagQ = { q: string; hint?: string; opts: DiagOpt[]; categoria: number };

const DIAG_CATEGORIAS = [
  { titulo: "Estrutura", desc: "Porte e maturidade da operação" },
  { titulo: "Controle Financeiro", desc: "Visibilidade de margem e caixa" },
  { titulo: "Operação & Equipe", desc: "Como o financeiro é executado hoje" },
  { titulo: "Estratégia", desc: "Planejamento, KPIs e tomada de decisão" },
];
...
const DIAG12: DiagQ[] = [
  ...
  { categoria: 0,
    q: "Há quanto tempo a empresa está em operação?",
    opts: [
      { label: "Menos de 1 ano", risco: 2 },
      { label: "1 a 3 anos", risco: 2 },
      { label: "3 a 7 anos", risco: 1 },
      { label: "Mais de 7 anos", risco: 1 },
    ]},
  { categoria: 0,
    q: "Qual é o regime tributário atual?",
    opts: [
      { label: "Simples Nacional", risco: 1 },
      { label: "Lucro Presumido", risco: 2 },
      { label: "Lucro Real", risco: 2 },
      { label: "Não sei dizer", risco: 3 },
    ]},
  // Controle Financeiro
  { categoria: 1,
  ...
  { categoria: 1,
    q: "Quando foi seu último fechamento financeiro mensal?",
    opts: [
      { label: "Faço todo mês, com DRE", risco: 0 },
      { label: "Faço de vez em quando", risco: 2 },
      { label: "Faz mais de 3 meses", risco: 3 },
      { label: "Nunca fiz fechamento mensal", risco: 3 },
    ]},
  { categoria: 1,
    q: "Suas contas pessoais e da empresa estão totalmente separadas?",
    opts: [
      { label: "Totalmente separadas", risco: 0 },
      { label: "Quase tudo, mas tem mistura", risco: 2 },
      { label: "Misturado com frequência", risco: 3 },
      { label: "Não há separação clara", risco: 3 },
    ]},
  // Operação & Equipe
  { categoria: 2,
  ...
  { categoria: 2,
    q: "Com que frequência você concilia o banco?",
    opts: [
      { label: "Diariamente", risco: 0 },
      { label: "Semanalmente", risco: 1 },
      { label: "Mensalmente", risco: 2 },
      { label: "Raramente / nunca", risco: 3 },
    ]},
  // Estratégia
  { categoria: 3,
    q: "Você opera com orçamento anual ou planejamento financeiro?",
    opts: [
      { label: "Sim, revisado mensalmente", risco: 0 },
      { label: "Tenho orçamento, mas não acompanho", risco: 2 },
      { label: "Faço só projeções pontuais", risco: 2 },
      { label: "Não tenho orçamento", risco: 3 },
    ]},
  { categoria: 3,
    q: "Você acompanha KPIs financeiros (margem, ticket, CAC, LTV)?",
    opts: [
      { label: "Sim, em dashboard recorrente", risco: 0 },
      { label: "Acompanho alguns indicadores", risco: 1 },
      { label: "Olho quando preciso", risco: 2 },
      { label: "Não acompanho KPIs", risco: 3 },
    ]},
  { categoria: 3,
    ...
    opts: [
      ...
      { label: "Meu contador só aparece no IR", risco: 2 },
      { label: "Não tenho relatórios para decidir", risco: 3 },
    ]},
];
...
function diagResultado(answers: (number | null)[]) {
  ...
  const margemNaoSabe = answers[3] === 2 || answers[3] === 3;
  const semControle = answers[6] === 3;
  if ((margemNaoSabe && semControle) || pct >= 75) {
    return {
      titulo: "Diagnóstico: Alto risco financeiro",
      cor: "#b94a3a",
      score: total, max,
      linhas: [
        "Sua empresa opera no escuro: sem visibilidade clara de margem nem controle estruturado.",
...
export function Diagnostico() {
  ...
  const set = (i: number) => {
    ...
    next[step] = i;
    setAnswers(next);
    setTimeout(() => setStep((s) => Math.min(total, s + 1)), 240);
  };

  const reset = () => { setStep(0); setAnswers(Array(total).fill(null)); };
  const resultado = useMemo(() => diagResultado(answers), [answers]);
  const currentQ = !isResult ? DIAG12[step] : null;
  const catAtual = currentQ?.categoria ?? 0;

  // progresso por categoria
  const catProgress = DIAG_CATEGORIAS.map((_, ci) => {
    const idxs = DIAG12.map((q, i) => (q.categoria === ci ? i : -1)).filter((x) => x >= 0);
    const done = idxs.filter((i) => answers[i] !== null).length;
    return { done, total: idxs.length };
  });
    ...
    <section id="diagnostico" className="py-24 lg:py-32" style={{ background: "#f4f1ec" }}>
      <div className="max-w-[1320px] mx-auto px-6 lg:px-10">
        <div className="max-w-3xl mb-12">
          ...
          <h2 className="font-display font-semibold text-[32px] lg:text-[48px] mt-4 leading-[1.05]" style={{ color: "#1F3D2E" }}>
            Diagnóstico Financeiro Gratuito — <span className="italic" style={{ color: "#005a54" }}>3 minutos</span>
          </h2>
          <p className="mt-5 text-[17px] leading-relaxed" style={{ color: "#1F3D2E", opacity: 0.7 }}>
            12 perguntas em 4 dimensões. Ao final, você recebe uma análise técnica do seu estágio financeiro e o próximo passo recomendado.
          </p>
        </div>
...
const METODO_ETAPAS: Etapa[] = [
  {
    ...
    desc: "Levantamos o estado real do financeiro: extratos, faturamento, contratos, sistemas e equipe. Você recebe um Raio-X completo e o plano de implantação 30/60/90 aprovado por você.",
    entregaveis: [
      "Raio-X Financeiro completo da operação",
      "Mapeamento de contas, sistemas e contratos vigentes",
      "Levantamento de receitas, despesas fixas e variáveis",
      "Análise do fluxo de caixa dos últimos 3 meses",
      "Identificação de gargalos, riscos e passivos",
      "Plano de implantação 30/60/90 aprovado pelo cliente",
    ],
  },
  {
    n: "02", titulo: "Fundação", periodo: "Semanas 2 e 3", fase: "implantacao",
    desc: "Construímos plano de contas, políticas de pagamento e cobrança, POPs e acessos. Você passa a ter uma estrutura escrita e padronizada para operar com previsibilidade — sem improviso.",
    entregaveis: [
      "Plano de contas personalizado para o segmento",
      "Políticas financeiras escritas (aprovação, limites, alçadas)",
      "POPs — Procedimentos Operacionais Padrão documentados",
      "Configuração e organização de acessos bancários e sistemas",
  ...
  },
  {
    ...
    desc: "Trazemos a operação para dentro do método, com supervisão intensiva e o primeiro fechamento mensal. Operação rodando, equipe Cluny entrosada e primeiro DRE gerencial entregue.",
    entregaveis: [
      ...
      "DRE Gerencial do período de transição",
  ...
  },
  {
    ...
    desc: "Executamos o dia a dia: pagar, receber, conciliar, projetar caixa e organizar documentos. O financeiro funciona como um relógio, com saldos batidos toda semana e caixa projetado para 90 dias.",
    entregaveis: [
      "Lançamentos diários de receitas e despesas",
      "Gestão de contas a pagar e a receber",
      "Conciliação bancária semanal com saldos batidos",
      "Controle de inadimplência e cobranças",
      "Projeção de caixa rolante de 90 dias",
      "Atendimento e suporte à equipe operacional",
    ],
  },
  {
    n: "05", titulo: "Gestão", periodo: "Cadência mensal e trimestral", fase: "ciclo",
    desc: "Fechamos o mês, geramos DRE/DFC/dashboard e conduzimos reuniões mensais e trimestrais com OKRs. Clareza para decidir: você sabe o que vai bem, o que precisa atenção e qual é o próximo passo.",
    entregaveis: [
      "DRE mensal (Demonstração do Resultado do Exercício)",
      "DFC mensal (Demonstração do Fluxo de Caixa)",
      "Dashboard gerencial atualizado",
      "Reunião mensal de análise de resultado",
      "Reunião trimestral de OKRs financeiros",
